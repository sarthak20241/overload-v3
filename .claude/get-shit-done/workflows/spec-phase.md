...
```bash
INIT=$(node "/Users/sarthakkumar/Coding/overload-v3/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/sarthakkumar/Coding/overload-v3/.claude/get-shit-done/templates/spec.md.
